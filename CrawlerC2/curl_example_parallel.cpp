...
std::list< string > download_products_links_LOOP(std::string url,Semaphore& mutex_access_List_link_products,Semaphore& pc_available_List_link_products, bool download_products_linksDone){
    std::string vazio ="";
...
std::list< string >  download_HTMLpages_products_LOOP(std::string url,Semaphore& mutex_access_List_HTML_products,Semaphore& pc_available_List_HTML_products, Semaphore&  pc_available_List_link_products,Semaphore& mutex_access_List_link_products,bool download_products_linksDone, bool download_HTMLpages_productsDone){
...
int main(void)
{
    ...
    //Criando Threads
    // std::thread Thread1(download_products_links_LOOP,std::ref(url),std::ref(mutex_access_List_link_products),std::ref(pc_available_List_link_products),std::ref(download_products_linksDone));//, std::ref(url),std::ref(),std::ref()
    // std::thread Thread2(download_HTMLpages_products_LOOP, std::ref(url),std::ref(mutex_access_List_HTML_products),std::ref(pc_available_List_HTML_products),std::ref(pc_available_List_link_products),std::ref(mutex_access_List_link_products),std::ref(download_products_linksDone),std::ref(download_HTMLpages_productsDone));
